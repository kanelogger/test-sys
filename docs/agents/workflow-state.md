...
- `系统分析师备考总计划.md`、`需求方案.md` 的种子日期约束与运行时校验已同步到 9/8；后续继续集成唯一 `public/data/` 路径，不另造内容基线。
...
- 事实来源：`系统分析师备考总计划.md` 2026-09-08 版明确从零启动，执行期 9/8—10/23，9/1—9/7 学习投入为 0 且旧日程退出执行表；理论上限 95.5 小时，必做 89 小时，缓冲 6.5 小时。
